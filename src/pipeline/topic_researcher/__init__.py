    ...
    async def query_trending(
        ...
        if script_style == "kids_rhyming":
            prompt = (
                ...
                "• 5 topics MUST be classic nursery rhyme or learning themes: animals, colors, "
                ...
                "• 5 topics MUST be kids-friendly character or superhero adaptations "
                "(e.g. 'Baby Shark Dance', 'Finger Family Song', 'Colors with Peppa Pig', "
                "'Spiderman Colors for Toddlers', 'Baby Batman Counting Song', "
                "'Superhero ABC for Kids', 'Baby Hulk Counting Song', "
                "'Spiderman and Friends Colors', 'Baby Avengers Learning Numbers'). "
                ...
                "NO anime battles, NO violence, NO adult themes.\n"
                ...
                "'Old MacDonald Had a Farm', 'Spiderman Colors for Toddlers', "
                "'Baby Shark Dance', 'Baby Hulk Counting 1 to 10'.\n"
