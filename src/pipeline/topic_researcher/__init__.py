    ...
    async def query_trending(
        ...
        if script_style == "kids_rhyming":
            prompt = (
                ...
                "STRICT MIX REQUIRED — exactly follow this breakdown:\n"
                "• 8 topics MUST be classic nursery rhyme or learning themes: animals, colors, "
                "numbers, ABCs, shapes, seasons, holidays, body parts, food, emotions, "
                "action songs (jumping, clapping, dancing), classic songs "
                "(Wheels on the Bus, Twinkle Twinkle, Baa Baa Black Sheep, Old MacDonald, "
                "Itsy Bitsy Spider, Row Your Boat, Head Shoulders Knees Toes, "
                "If You're Happy and You Know It, Rain Rain Go Away).\n"
                "• ONLY 2 topics may be kids-friendly character adaptations "
                "(e.g. 'Baby Shark Dance', 'Finger Family Song', 'Colors with Peppa Pig', "
                "'Spiderman Colors for Toddlers', 'Baby Batman Counting Song', "
                "'Superhero ABC for Kids'). "
                "These must be educational and toddler-safe — NO superhero fights or battles.\n"
                "All 10 topics must be 100% age-appropriate for children aged 1-5. "
                "NO anime, NO superhero battles, NO violence, NO adult themes.\n"
                "Format: numbered list 1-10, one topic per line, short title (4-8 words max). "
                "Examples: 'Five Little Ducks Counting Song', 'ABC Alphabet for Kids', "
                "'Old MacDonald Had a Farm', 'Colors of the Rainbow Song', "
                "'Baby Shark Dance', 'Wheels on the Bus Sing Along'.\n"
                "Write entirely in English. Output ONLY the numbered list."
                + exclusion_block
            )
            system_content = (
                ...
                "You MUST follow the strict topic mix: 8 classic nursery rhyme/learning topics "
                "and only 2 character/brand adaptations per batch of 10. "
                "Never exceed 2 character topics — classic educational content is the priority. "
